	...
	return (
		<SafeAreaView className="flex-1 bg-gray-300">
			...
			<View className="bg-muni-50 rounded-b-2xl py-1 pb-2">
				<View
					className="bg-white rounded-r-full py-1 my-1 mr-28"
					style={shadowStyles.shadow}
				>
					<Text className="font-bold text-center">
						Tienes estas horas pendientes
					</Text>
				</View>
				<View className="p-1 px-4">
					<View
						className="bg-white flex flex-row items-center space-x-2 p-1 py-2 rounded-[32px]"
						style={shadowStyles.shadow}
					>
			...
			<View className="mt-1">
				<ScrollView>
					<View className="items-center mb-2">
						<View
							className="bg-white flex flex-row rounded-[12px] p-1"
							style={shadowStyles.shadow}
						>
							<Link href="/marcarAsis" asChild>
								<TouchableOpacity
									className="bg-yellow-500 m-3 py-4 rounded-[12px] w-1/4"
									style={shadowStyles.shadow}
								>
									<View className="items-center">
										<MaterialIcons
							...
							<View
								className="bg-muni-50 p-1 px-2 mx-2 items-center rounded-[12px]"
								style={shadowStyles.shadow}
							>
								<Image
							...
							<Link href="/perfilPrestador" asChild>
								<TouchableOpacity
									className="bg-yellow-500 m-3 py-4 px-5 rounded-[12px] w-1/4"
									style={shadowStyles.shadow}
								>
									<View className="items-center">
										<FontAwesome6
