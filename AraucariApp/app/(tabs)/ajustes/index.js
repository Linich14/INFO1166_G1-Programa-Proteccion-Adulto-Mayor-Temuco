			...
			<View className="w-full h-screen">
				<View className="bg-muni-50 py-2">
					<View className="rounded-full bg-white mx-auto w-2/3">
						<Text
							style={{ fontSize }}
							className="font-bold text-gris-50 text-center px-1"
						>
							Ajustes
						</Text>
					</View>
					...
					<View className="bg-white p-5 rounded">
						{notifications.length > 0 ? (
							<>
								...
								<Text
									style={{ fontSize, textAlign: "center", marginVertical: 10 }}
								>
						...
						<TouchableOpacity
							onPress={nextNotification}
							style={{ marginTop: 20 }}
						>
							<View className="bg-muni-50 p-2 rounded-full">
								<Text style={{ fontSize, color: "white", textAlign: "center" }}>
									OK
								</Text>
							</View>
						</TouchableOpacity>
